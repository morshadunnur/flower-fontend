...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('flower.home') }}">Home</a></li>
    ...
    <!-- section start -->
    <section class="section-b-space" id="productDetailsPage">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-slick">
                                        <div><img :src="product.feature_image" alt=""
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right">
                                        <h2>@{{ product.title }}</h2>
                                        <h4>@{{ product.prices[0].selling_price }}</h4>
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                        ...
                                        <li class="nav-item"><a class="nav-link" id="profile-top-tab" data-toggle="tab"
                                                    ...
                                                    class="icofont icofont-man-in-glasses"></i>Images</a>
                                            <div class="material-border"></div>
                                        </li>
